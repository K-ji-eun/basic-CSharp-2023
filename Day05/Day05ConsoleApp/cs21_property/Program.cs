...
namespace cs21_property
{
    class Boiler
    {
        ...
        // 위의 get; set;과 비교
        // 아래의 Get 메서드와 Set 메서드는  Java에서만 사용 , C#은 거의 안씀
    ...
    class Car
    {
        ...
        // 들어오는 데이터를 필터링 할 때는 private 멤버변수와 public 프로퍼티를 둘다 사용
        public int Year
        {
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ///...
            //kitturami.temp = 300000;    // 보이러 물수온이 30만도?
            //kitturami.temp = -120;
            ...
            Car ionic = new Car();
            ionic.Name = "아이오닉";
            Console.WriteLine(ionic.Name); // set;없으면 값 입력 불가 
            ...
            Console.WriteLine("자동차 제조 회사는 {0}", genesis.Company);
            Console.WriteLine("자동차 제조 년도는 {0} 년 ", genesis.Year);
        }
    }
}