...
using System.Data;
using System.Diagnostics; // Process 객체
...
namespace wf07_myexplorer
{
    public partial class FrmExplorer : Form
    {
        ...
        private void FrmExplorer_Load(object sender, EventArgs e)
        {
            ...
            LsvFolder.Columns.Add("이름", (LsvFolder.Width / 2), HorizontalAlignment.Left);   // dir.Name
        ...
        private int SetExtImg(string name)
        {
            ...
            string ext = file.Extension; // 확장자를 가져옴
            var exVal = 0;
        ...
        private void TrvDrive_AfterSelect(object sender, TreeViewEventArgs e)
        {
            SetLsvFolder(e.Node.FullPath);
        }
